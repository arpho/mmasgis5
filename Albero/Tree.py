...
class Nodo():
	...
	"""
	def __init__(self,header,Id,cathegory,father,featId):
		"""
		...
		item.setData(0,3,QtCore.QVariant(cathegory[0:3]))
...
class SelectionList():
	...
	def getList(self):
		...
		@return: [Nodo]
		"""
		return self.selectionlist.iterkeys()
...
class Tree():
	...
	def childrenAdder(self,lf,lc):
		...
		""" 
		db = MySQLdb.connect(host="localhost", user="root", passwd="",db="mmasgisDB")
		crs=db.cursor()
		for father in lf:
			for child in lc:
