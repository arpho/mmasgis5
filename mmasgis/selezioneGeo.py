...
from Ui_selezionegeo import  Ui_SelezioneGeo
from Odict import *
from Tree import *
import re
...
class SelezioneGeoWindow(QMainWindow, Ui_SelezioneGeo):
	...
	def reset(self):
		...
		"""
		#print "resetted selectionlist"*30
		self.selectedList.reset()
	
	"""
	@return: [Nodo] lista delle Utb selezionate
	"""
	def getList(self):
		print "@@@lista in selezionegeo linea 39 {0}".format(len(self.selectedList.getList()))
		##settrace()
		p=self.selectedList.getList()
		return self.selectedList.getList()
	...
	def addElement(self,e):
		...
		#settrace()
		p=self.selectedList.getList()
		print "selezionegeo  142 added element",e
		
		#print "selezionegeo lista selezzioni: {0}".format(len(self.selectedList.getList())) 
