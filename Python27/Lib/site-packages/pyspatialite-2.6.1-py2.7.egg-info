...
Name: pyspatialite
Version: 2.6.1
Summary: DB-API 2.0 interface for SQLite 3.x with Spatialite 2.x
Home-page: http://pyspatialite.googlecode.com/
Author: Lokkju Brennr
Author-email: lokkju@lokkju.com
License: zlib/libpng license
Download-URL: http://code.google.com/p/pyspatialite/downloads/list
